...
public class MortyEnemy extends Enemy{
	...
	private static Image sprite = new Image("file:img/morty.png"); //sprite of enemy
	private static Image selectedSprite = new Image("file:img/selectedEnemies/mortySelected.png"); //sprite that runs when this enemy is selected
	private static Image characterImage = new Image("file:img/charactersImages/mortyImage.png"); //image of the enemy
	 ...
	 */
	public MortyEnemy(int xCoor, int yCoor) {
